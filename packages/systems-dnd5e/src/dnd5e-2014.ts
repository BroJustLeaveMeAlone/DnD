...
export const dnd5e2014: SystemModule = {
  ...
  derived: [
    { key: 'proficiency_bonus', name: 'Proficiency Bonus', formula: PROFICIENCY_BONUS },
    { key: 'speed', name: 'Speed', base: 30 },
    { key: 'hp.max', name: 'Hit Points', base: 0 },
    { key: 'initiative', name: 'Initiative', formula: 'attr.dex.mod' },
    { key: 'ac', name: 'Armor Class', formula: '10 + attr.dex.mod' },
    { key: 'attacks', name: 'Attacks per Action', base: 0 },
    { key: 'crit.range', name: 'Critical Range', base: 20 },
